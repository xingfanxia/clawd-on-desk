...
// 1. Defaults snapshot includes nudges with normal preset
{
  ...
  assert.strictEqual(d.version, 3, "defaults should be v3");
...
// 3. Migration from v0 (no version) cascades all the way to v3
{
...
// 8. Migration is idempotent — re-migrating a v3 file leaves it alone
{
  const already = {
    version: 3,
