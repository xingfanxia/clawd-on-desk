...
实现路线: **全 SVG + JS 驱动** (2026-04-26 锁定, 详见根目录 `AGENTS.md` 接入方式段). 现有 demo 微调后即生产代码.
...
6. **morph 70-90% 准形态比 100% 完美形态精致** — 球化 t=70% 验证. 后续任何 morph 类动作 (拓扑挤压 / 404 / yawn) 都先试 70-90% 不要默认 100% (跨状态原则, 已写进 AGENTS.md 宪法 §2 脚注)
