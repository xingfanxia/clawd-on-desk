...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      sectionAIFeatures: "AI Features",
      rowEnableAIFeatures: "Enable AI features",
      rowEnableAIFeaturesDesc: "Soul brain, screen observation, chat, persistent memory, diary, and agent hook auto-management. Off = pure desktop pet.",
      rowEnableAIFeaturesRestartNote: "Restart Clawd after toggling for the change to take effect.",
      // PAWPAL-1: Awareness tab strings (en)
      sidebarAwareness: "Awareness",
      sectionSelfCareNudges: "Self-Care Nudges",
      rowNudgePreset: "Nudge level",
      rowNudgePresetDesc: "How actively the cat reminds you to take breaks, drink water, and stand up. DND always overrides.",
      labelPresetQuiet: "Quiet",
      labelPresetNormal: "Normal",
      labelPresetCoach: "Coach",
      descPresetQuiet: "Cat reminds you only every 50 min for breaks. No hydration / sit alerts.",
      descPresetNormal: "Cat nudges every 25 min for breaks, every 90 min for water, after 30 min of sitting.",
      descPresetCoach: "Cat nudges actively — adds sound + macOS banner. Every 25 min break, every 60 min water, after 20 min sitting.",
      rowPomodoroEnabled: "Pomodoro break",
      ...
      // PAWPAL-2 Task 10: Workspace Awareness section (en)
      sectionWorkspaceAwareness: "Workspace Awareness",
      sectionWorkspaceAwarenessDesc: "Let the cat notice what app you're using and how long you've been at it. Detectors stay off until you grant macOS Accessibility / Input Monitoring.",
      rowWorkspaceMasterToggle: "Workspace awareness",
      rowWorkspaceMasterToggleDesc: "Master switch. Off = no app polling, no system probes, no window tracking.",
      rowWorkspaceActiveApp: "Active app reactions",
      rowWorkspaceActiveAppDesc: "Cat reacts to the kind of app you're in (code, chat, video, etc.). Requires Accessibility.",
      rowWorkspaceSystemMonitor: "System monitor",
      rowWorkspaceSystemMonitorDesc: "Stuck-on-problem nudges fire when you pause typing and CPU spikes. Requires Input Monitoring.",
      rowWorkspaceLongWindow: "Long-window break",
      rowWorkspaceLongWindowDesc: "Nudges you to switch context after the same window has been frontmost for a long stretch.",
      rowWorkspaceLongWindowThreshold: "Break threshold",
      rowWorkspaceLongWindowThresholdDesc: "Same-window time before the cat suggests a break.",
      optWorkspaceThreshold60: "60 minutes",
      optWorkspaceThreshold90: "90 minutes",
      optWorkspaceThreshold120: "120 minutes",
      // PAWPAL-3 integrations section
      sectionIntegrations: "Integrations",
      sectionIntegrationsDesc: "Let the cat react to other macOS signals — Now Playing tempo, battery state, screen lock. All sub-features stay off until enabled here.",
      rowIntegrationsMasterToggle: "Integrations",
      rowIntegrationsMasterToggleDesc: "Master switch. Off = no music poll, no battery poll, no system event listeners.",
      rowIntegrationsMusic: "Music sync",
      rowIntegrationsMusicDesc: "Cat bobs along when Apple Music plays a track above the BPM threshold.",
      rowIntegrationsBattery: "Battery low",
      rowIntegrationsBatteryDesc: "Cat carries a battery icon when the laptop runs low on battery power.",
      rowIntegrationsSystemEvents: "System events",
      rowIntegrationsSystemEventsDesc: "Cat reacts to screen lock / unlock and AC power transitions.",
      labelPermissionUnknown: "Checking…",
      labelPermissionGranted: "Granted ✓",
      labelPermissionDenied: "Permission not granted",
      labelPermissionRevoked: "Access revoked — re-grant in System Settings",
      labelPermissionUnavailable: "Not supported on this platform",
      labelAccessibilityPermission: "Accessibility",
      labelInputMonitoringPermission: "Input Monitoring",
      btnGrantAccess: "Grant access",
      btnGrantAccessWaiting: "Waiting for grant…",
      btnOpenSystemSettings: "Open System Settings",
      btnEditCategoryRules: "Edit category rules…",
      btnSave: "Save",
      btnCancel: "Cancel",
      btnResetToDefaults: "Reset to defaults",
      labelCategoryRulesTitle: "Category rules",
      labelCategoryRulesHint: "Map app or window-title substrings to a category. Categories: code, docs, social, chat, video, creative.",
      labelCategoryRulesEmpty: "Empty — uses defaults below.",
      labelCategoryRulesDefaults: "Default rules (collapsible)",
      errInvalidJson: "Invalid JSON: {message}",
      errInvalidCategory: "Category \"{category}\" is not one of {validList}",
    ...
    zh: {
      ...
      sectionAIFeatures: "AI 功能",
      rowEnableAIFeatures: "启用 AI 功能",
      rowEnableAIFeaturesDesc: "灵魂大脑、屏幕观察、对话、持久记忆、日记、Agent hooks 自动管理。关闭后即纯桌面宠物。",
      rowEnableAIFeaturesRestartNote: "切换后需要重启 Clawd 才能生效。",
      // PAWPAL-1: Awareness tab strings (zh)
      sidebarAwareness: "感知",
      sectionSelfCareNudges: "自我关怀提醒",
      rowNudgePreset: "提醒强度",
      rowNudgePresetDesc: "猫多积极地提醒你休息、喝水、起来活动。勿扰模式始终优先。",
      labelPresetQuiet: "安静",
      labelPresetNormal: "普通",
      labelPresetCoach: "教练",
      descPresetQuiet: "每 50 分钟提醒一次休息。不提醒喝水和久坐。",
      descPresetNormal: "每 25 分钟提醒休息，每 90 分钟提醒喝水，久坐 30 分钟提醒站起来。",
      descPresetCoach: "猫主动催你 — 还会响声音和 macOS 通知。25 分钟休息、60 分钟喝水、久坐 20 分钟就提醒。",
      rowPomodoroEnabled: "番茄钟休息",
      ...
      // PAWPAL-2 Task 10: Workspace Awareness section (zh)
      sectionWorkspaceAwareness: "工作环境感知",
      sectionWorkspaceAwarenessDesc: "让猫感知你在用什么应用、用了多久。需要先在 macOS 系统设置里授予 Accessibility / Input Monitoring 权限。",
      rowWorkspaceMasterToggle: "工作环境感知",
      rowWorkspaceMasterToggleDesc: "总开关。关闭后不会轮询前台应用、不监控系统状态、不追踪窗口。",
      rowWorkspaceActiveApp: "前台应用反应",
      rowWorkspaceActiveAppDesc: "根据你在用什么应用让猫做出反应（写代码、聊天、看视频等）。需要 Accessibility 权限。",
      rowWorkspaceSystemMonitor: "系统监控",
      rowWorkspaceSystemMonitorDesc: "停下打字 + CPU 飙升时触发「卡壳」提示。需要 Input Monitoring 权限。",
      rowWorkspaceLongWindow: "长时间同一窗口提醒",
      rowWorkspaceLongWindowDesc: "同一窗口在最前面太久时，提醒你切换一下。",
      rowWorkspaceLongWindowThreshold: "提醒阈值",
      rowWorkspaceLongWindowThresholdDesc: "同一窗口持续多久后提醒。",
      optWorkspaceThreshold60: "60 分钟",
      optWorkspaceThreshold90: "90 分钟",
      optWorkspaceThreshold120: "120 分钟",
      // PAWPAL-3 集成模块
      sectionIntegrations: "集成模块",
      sectionIntegrationsDesc: "让猫对其他 macOS 信号做出反应 — 正在播放的节奏、电池状态、屏幕锁定。子功能默认关闭，启用后才生效。",
      rowIntegrationsMasterToggle: "集成模块",
      rowIntegrationsMasterToggleDesc: "总开关。关闭后不会轮询音乐、不监控电池、不监听系统事件。",
      rowIntegrationsMusic: "音乐同步",
      rowIntegrationsMusicDesc: "当 Apple Music 播放节奏超过 BPM 阈值时，猫会跟着摇晃。",
      rowIntegrationsBattery: "电量低提醒",
      rowIntegrationsBatteryDesc: "笔记本电量不足时，猫会抱着电池图标。",
      rowIntegrationsSystemEvents: "系统事件",
      rowIntegrationsSystemEventsDesc: "猫会对屏幕锁定 / 解锁以及电源切换做出反应。",
      labelPermissionUnknown: "正在检测…",
      labelPermissionGranted: "已授权 ✓",
      labelPermissionDenied: "未授权",
      labelPermissionRevoked: "权限已撤销 — 请到系统设置重新授予",
      labelPermissionUnavailable: "当前平台不支持",
      labelAccessibilityPermission: "Accessibility",
      labelInputMonitoringPermission: "Input Monitoring",
      btnGrantAccess: "授予权限",
      btnGrantAccessWaiting: "正在等待授权…",
      btnOpenSystemSettings: "打开系统设置",
      btnEditCategoryRules: "编辑分类规则…",
      btnSave: "保存",
      btnCancel: "取消",
      btnResetToDefaults: "恢复默认",
      labelCategoryRulesTitle: "分类规则",
      labelCategoryRulesHint: "把应用名 / 窗口标题里的关键词映射到一个类别。可用类别：code, docs, social, chat, video, creative。",
      labelCategoryRulesEmpty: "为空 — 将使用下方的默认规则。",
      labelCategoryRulesDefaults: "默认规则（可展开）",
      errInvalidJson: "JSON 不合法：{message}",
      errInvalidCategory: "类别 \"{category}\" 不在合法列表 {validList} 中",
    ...
    ko: {
      ...
      sectionAIFeatures: "AI 기능",
      rowEnableAIFeatures: "AI 기능 사용",
      rowEnableAIFeaturesDesc: "영혼 두뇌, 화면 관찰, 채팅, 지속 메모리, 일기, 에이전트 훅 자동 관리. 끄면 순수 데스크톱 펫.",
      rowEnableAIFeaturesRestartNote: "변경 사항을 적용하려면 Clawd를 재시작하세요.",
      // PAWPAL-1: Korean strings stub — fall back to English copy for v1.
      ...
      rowLongWindowBreakEnabled: "Long-window break",
      nudgeSuppressedByPreset: "Suppressed by current preset — won't fire",
      // PAWPAL-2 Task 10 Workspace Awareness — Korean stub falls back to English.
      sectionWorkspaceAwareness: "Workspace Awareness",
      sectionWorkspaceAwarenessDesc: "Let the cat notice what app you're using and how long you've been at it. Detectors stay off until you grant macOS Accessibility / Input Monitoring.",
      rowWorkspaceMasterToggle: "Workspace awareness",
      rowWorkspaceMasterToggleDesc: "Master switch. Off = no app polling, no system probes, no window tracking.",
    ...
    ja: {
      ...
      sectionAIFeatures: "AI 機能",
      rowEnableAIFeatures: "AI 機能を有効にする",
      rowEnableAIFeaturesDesc: "魂の脳、画面観察、チャット、永続メモリ、日記、エージェントフック自動管理。オフ = ピュアなデスクトップペット。",
      rowEnableAIFeaturesRestartNote: "変更を反映するには Clawd を再起動してください。",
      // PAWPAL-1: Japanese strings stub — fall back to English copy for v1.
      // Localize in a follow-up.
      sidebarAwareness: "Awareness",
      sectionSelfCareNudges: "Self-Care Nudges",
      rowNudgePreset: "Nudge level",
      ...
      rowLongWindowBreakEnabled: "Long-window break",
      nudgeSuppressedByPreset: "Suppressed by current preset — won't fire",
      // PAWPAL-2 Task 10 Workspace Awareness — Japanese stub falls back to English.
      sectionWorkspaceAwareness: "Workspace Awareness",
      sectionWorkspaceAwarenessDesc: "Let the cat notice what app you're using and how long you've been at it. Detectors stay off until you grant macOS Accessibility / Input Monitoring.",
      rowWorkspaceMasterToggle: "Workspace awareness",
      rowWorkspaceMasterToggleDesc: "Master switch. Off = no app polling, no system probes, no window tracking.",
